<template>
  ...
  <div class="pt-4 text-2xl text-center">
    <span class="font">
      <div><span class="text-red-600">Professional Website</span> <span>Monitoring</span></div>
    </span>
  </div>
  ...
  <div class="h-full ml-14 mb-10 md:ml-64 text-black pt-14 pl-24 pr-72 mr-20 ">
    <div class="flex-col min-w-0 mb-4 lg:mb-0 break-words mx-12 bg-gray-200 mt-4 ">
      <div class="dashboard mx-4">
        <main v-if="endpointuri && endpointuri.length"></main>
        <main v-else>
    ...
    <div class="pt-4 ml-20 text-gray-500 hover:text-gray-700">
      <NuxtLink to="publicuser"><span>Return</span></NuxtLink>
    </div>
  </div>

  <div class="overflow-x-auto sm:mx-0.5 lg:mx-0.5"></div>
</template>
