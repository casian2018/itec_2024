      ...
      <div class="h-full ml-14 mb-10 md:ml-64">
        ...
        <div class="relative flex flex-col min-w-0 mb-4 lg:mb-0 break-words  w-full  ">
          ...
          <div class="dashboard ">
            ...
            <div class="endpoint-item grid grid-cols-3 ">
              <p class="endpoint-url ">{{ endpoint.url }}</p>
              <p class="endpoint-status ">
                Status: {{ endpoint.status }}
                <span class="ml-2 text-xs font-medium rounded-full px-1" :class="`bg-${endpoint.status}-500`">
                  {{ endpoint.status }}
                </span>
              </p>
              <div class="w-full bg-gray-200 rounded ">
                <div :class="`bg-${color}-500 text-xs font-medium text-blue-100 text-center p-0.5 leading-none rounded`"
                  :style="{ width: `${endpoint.statusWidth}%` }">
...
export default {
  ...
  async mounted() {
    ...
    // Implement updateCallHistory function to update call history after receiving a response
