        ...
        <div x-data="{ sidebarOpen: false }" class="flex h-screen bg-gray-200">
            ...
            <div class="flex flex-col flex-1 overflow-hidden">
                <header class="flex items-center justify-between px-6 py-4 bg-white border-b-4 border-indigo-600">
                    <div class="flex items-center">
                        <button onclick="sidebarOpen" class="text-gray-500 focus:outline-none lg:hidden">
                    ...
                    <div class="flex items-center">
                        <div x-data="{ notificationOpen: false }" class="relative">
                            <button onclick="notificationOpen" class="flex mx-4 text-gray-600 focus:outline-none">
                                <svg class="w-6 h-6" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path
                            ...
                            <div x-show="notificationOpen" class="fixed inset-0 z-10 w-full h-full"
