<template>
    <section class="max-w-5xl mx-auto w-full px-10">
        <div class="flex items-center justify-center flex-col gap-y-2 py-5">
            ...
            <p class="text-lg font-medium text-slate-700/70 ">Discover how our service can benefit you
            </p>
        </div>
        <div class="grid grid-cols-1 lg:grid-cols-5 gap-5 w-full">
            <div
                ...
                <div class="flex flex-col gap-y-3.5">
                    ...
                    <p class="font-medium text-slate-700/90 ">All eFounders teams have moved to Cycle
                        for all
            ...
            <div
                ...
                <div class="flex flex-col gap-y-3.5">
                    ...
                    <p class="font-medium text-slate-700/90 ">The customer support team at our service
                        is
                ...
                <div class="flex flex-col">
                    ...
                    <p class="text-sm font-medium text-slate-700/70 ">Marketing Manager at ABC Company
                    </p>
                </div>
            </div>
            <div
                ...
                <div class="flex flex-col gap-y-3.5">
                    ...
                    <p class="font-medium text-slate-700/90 ">Integrating our systems with our service
                        was smooth
            ...
            <div
                ...
                <div class="flex flex-col gap-y-3.5">
                    ...
                    <p class="font-medium text-slate-700/90 ">Our service has consistently maintained
                        high uptime,
