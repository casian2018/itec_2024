<template>
    <Nav />
    <div class="max-w-screen-lg mx-auto p-5 flex min-h-screen items-center">
    <div class="grid grid-cols-1 md:grid-cols-12 border">
        ...
        <form class="md:col-span-8 p-10" @submit.prevent="submitForm">
            <div class="flex flex-wrap -mx-3 mb-6">
                <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                    ...
                    <input
                        ...
                        id="grid-first-name" type="text" placeholder="Jane" name="first_name" v-model="formData.first_name">
                ...
                <div class="w-full md:w-1/2 px-3">
                    ...
                    <input
                        ...
                        id="grid-last-name" type="text" placeholder="Doe" name="last_name" v-model="formData.last_name">
                </div>
            </div>
            <div class="flex flex-wrap -mx-3 mb-6">
                <div class="w-full px-3">
                    ...
                    <input
                        ...
                        id="grid-email" type="email" placeholder="********@*****.**"  name="email" v-model="formData.email">
                </div>
            </div>
            ...
            <div class="flex flex-wrap -mx-3 mb-6">
                <div class="w-full px-3">
                    ...
                    <textarea rows="10" v-model="formData.message" name="message"
